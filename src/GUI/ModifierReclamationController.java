...
public class ModifierReclamationController implements Initializable {
    ...
    private void redirectDashboard(ActionEvent event) throws IOException, SQLException {
        ...
        selon.getScene().getWindow().hide();
        selon.getScene().getWindow();
    ...
    private void modifier(ActionEvent event) {
        ...
        Reclamation rOld = new Reclamation();
        rOld.setId(idRec);
        ...
        rcrd.modifierReclamation(r,rOld);
        System.out.println("added");
        
        
                     Notifications notificationBuilder = Notifications.create()
                    .title("Effectué")
                    .text("Réclamation Modifiée Avec Succès")
                     .graphic(null)
    ...
    @FXML
    private void signout350(ActionEvent event) throws IOException {
         selon.getScene().getWindow().hide();
